...
Generate a treatment group that starts at the same initial value as the control group with a different slope.
...
Let's compare the treatment group with the control group.

```{r, echo=FALSE}
plot(days, apply(y_contrl, 2, mean), 'o', col=2, main="Time vs. Mean Weight", xlab="Time", ylab="Mean Weight")
lines(days, apply(y_trt, 2, mean) , 'o', col=3, main="Time vs. Mean Weight", xlab="Time", ylab="Mean Weight")
legend("topright", c("Control grp", "trt grp 1"), lty=1, col=c(2, 3))
```
